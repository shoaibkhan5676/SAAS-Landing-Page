    ...
    return <section className="py-28 lg:py-40">
        <div className="container">
            <div className="sticky top-20 md:top-28 lg:top-30">
                ...
                <div className="text-4xl md:text-6xl text-center font-medium lg:text-7xl mt-10">
                    <span className="">Yours creative process deserve better. </span>
                    <span className="">
                    {words.map((word,wordIndex)=>(
                        <span className={twMerge("transition duration-500 text-white/15",wordIndex<currentWord&&"text-white")} key={wordIndex}>
                            {`${word} `}
                        </span>
                    ))}
                    </span>
